class Game{
	constructor(){
		...
		options.assets.push(`${game.assetsPath}fbx/town1own.fbx`);
	...
	init() {
		...
		swal({
			title: "You are entering in a 3d world..",
			text: "There are a lot of people. If you want to interact with each other, Kindly click the person you want to talk and start talking..",
			icon: "warning",
			buttons: true,
			dangerMode: true,
		  })
	...
	loadEnvironment(loader){
		const game = this;
		loader.load(`${this.assetsPath}fbx/town1own.fbx`, function(object){
	...
	playerControl(forward, turn){
		turn = -turn;
		// const zzz = this.player.object.position.clone()
		// console.log(zzz.x.toFixed(2))
		// if(zzz.x ===277)
...
class Player{
	constructor(game, options){
		...
		if (options===undefined){
			const people = ['BusinessMan', 'Doctor', 'FireFighter', 'Housewife', 'Policeman', 'Prostitute', 'Punk', 'RiotCop', 'Roadworker', 'Robber', 'Sheriff', 'Streetman', 'Waitress'];
			// 'BusinessMan', 'Doctor', 'FireFighter', 'Housewife', 'Policeman', 'Prostitute', 'Punk', 'RiotCop', 'Roadworker', 'Robber', 'Sheriff', 'Streetman', 'Waitress'
